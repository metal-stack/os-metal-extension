...
func (t *IgnitionGenerator) Generate(logr logr.Logger, config *generator.OperatingSystemConfig) ([]byte, *string, error) {
	...
	cfg, err := ignitionFromOperatingSystemConfig(config)
	if err != nil {
		return nil, nil, err
	}
...
func ignitionFromOperatingSystemConfig(config *generator.OperatingSystemConfig) (types.Config, error) {
	cfg := types.Config{}
	...
	if config.Object != nil && config.Object.Spec.ProviderConfig != nil {
		...
		if err != nil {
			return types.Config{}, fmt.Errorf("unable to decode providerConfig")
		}
	}
